...
class Empty_CC_2(PredefinedWindow):
    ...
    def export_to_txt(self):
        ...
        for location in locations:
            script_content += f'ControlSend,, {location}, {window_title}\n'
            script_content += f'Sleep, {sleep_time}\n'
            script_content += f'ControlSend,, {{Enter}}, {window_title}\n'
            script_content += f'Sleep, {sleep_time}\n'
            script_content += 'ControlSend,, ^A, {window_title}\n'
            script_content += f'Sleep, {sleep_time}\n'
            script_content += 'ControlSend,, ^N, {window_title}\n'
            script_content += f'Sleep, {sleep_time}\n'
