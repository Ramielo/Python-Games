...
Please consult the release notes for data format and additional information.\n"""
    ...
    def import_excel(self):
        ...
        # 尝试找到Received date time
        
        if datetime_col:
            datetime_data = df_full[datetime_col[0]].tolist() # 找到符合条件的列，获取其数据
            ...
            for date_str in datetime_data:
                ...
                delta = round((now - date_time).total_seconds() / 86400, 2) # 计算时间差，以day为单位的浮点数
